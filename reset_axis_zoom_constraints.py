...
with dpg.window() as wnd:
    ...
    dpg.add_button(label="Reset limits on X", callback=lambda: dpg.reset_axis_zoom_constraints(x_axis))
    dpg.add_button(label="Reset limits on Y", callback=lambda: dpg.reset_axis_zoom_constraints(y_axis))
